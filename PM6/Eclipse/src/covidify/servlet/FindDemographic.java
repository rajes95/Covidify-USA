...
/**
 * FindDemographic is the primary entry point into the application.
 * <p>
...
@WebServlet("/finddemographic")
public class FindDemographic extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    County county = null;
    List<Demographics> demographics = null;
    ...
    if (statename == null || statename.trim().isEmpty() || countyname == null || countyname.trim().isEmpty()) {
      ...
      try {
        ...
        demographics = demographicDao.getDemographicsByCounty(county);
    ...
    req.getRequestDispatcher("/FindDemographic.jsp").forward(req, resp);
  }
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (statename == null || statename.trim().isEmpty() || countyname == null || countyname.trim().isEmpty()) {
      ...
      try {
        county = countyDao.getCountyByCountyNameAndStateName(countyname, statename);
        if (county == null) {
          messages.put("success", "County does not exist. Could not locate Demographic List.");
        } else {
          demographics = demographicDao.getDemographicsByCounty(county);
          if (demographics == null) {
            messages.put("success", "Demographic List does not exist.");
          }
        }
      } catch (SQLException e) {
        e.printStackTrace();
