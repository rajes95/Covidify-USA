...
public class FindMortalityRates extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    County county = null;
    List<MortalityRates> mortalityRates = null;
    ...
    if (statename == null || statename.trim().isEmpty() || countyname == null || countyname.trim().isEmpty()) {
      ...
      try {
        ...
        mortalityRates = mortalityRatesDao.getMortalityRatesByCounty(county);
    ...
    req.setAttribute("mortalityRates", mortalityRates);

    req.getRequestDispatcher("/FindMortalityRates.jsp").forward(req, resp);
  }
