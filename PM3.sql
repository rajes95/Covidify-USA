...
#2. Top 5 and Least 5 states- how did they vote?

select StateKey, StateName, PresidentialElectionVotePercentages.`Year` as ElectionYear,
...
having (DemPerc is not null and RepPerc is not null and OtherPerc is not null); 
