...
ENGINE = INNODB;
LOAD DATA INFILE './States_unemployment_March2020-April2020_season.csv' 
...
INTO OUTFILE './Q2-1_AprilNewCovidCasesVSUnemploymentData.csv'
...
GROUP BY PostalCode
ORDER BY PostalCode
INTO OUTFILE './Q2-2_MarchToAprilIncreaseNewCovidCasesVSUnemploymentData.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'; 
