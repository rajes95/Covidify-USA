...
<body>
	...
	<br/>
	<div id="presidentialElectionPercentcreate"><a href="presidentialElectionPercentcreate">Create Election Percentage Entry</a></div>
	<div id="presidentialElectionPercentdelete"><a href="presidentialElectionPercentdelete">Delete Election Percentage Data Entry</a></div>
	<div id="presidentialElectionPercentupdate"><a href="presidentialElectionPercentupdate">Update Election Percentage Data Entry</a></div>
	<br/>
	<h1>Matching PresidentialElectionPercent Data Entry</h1>
        <table border="1">
            <tr>
                ...
                <tr>
					<td><c:out value="${presidentialElectionPercent.getCounty().getCountyName()}" /></td>
					<td><c:out value="${presidentialElectionPercent.getYear()}" /></td>
					<td><c:out value="${presidentialElectionPercent.getDemocratsPercent}" /></td>
					<td><c:out value="${presidentialElectionPercent.getRepublicansPercent()}" /></td>
					<td><c:out value="${presidentialElectionPercent.getOtherPercent()}" /></td>
                </tr>

       </table>
		<br/><br/>
       <div id="findcovidbydate"><a href="findcovidbydate">Find COVID-19 Data Entry</a></div>
       <div id="findpresidentialElectionPercent"><a href="findpresidentialElectionPercent">Find presidentialElectionPercent  Data Entry</a></div>
       ...
       <div id="presidentialElectionPercentcreate"><a href="presidentialElectionPercentcreate">Create a PresidentialElectionPercent Entry</a></div>
