...
<title>Create a County Hospital Entry</title>
</head>
<body>
	<h1>Create a County Hospital Entry</h1>
	<form action="countyhospitalcreate" method="post">
		<p>
		...
		<p>
			...
			<input id="icuBeds" name="icuBeds" value="">
		</p>
		<p>
			<input type="submit">
		</p>
